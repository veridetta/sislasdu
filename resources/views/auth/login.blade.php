      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <a href="#" class="brand-logo">
            <h2 class="brand-text text-warning ms-1">SISLASDU | Desa Bakunglor</h2>
          </a>
          ...
          <form class="auth-login-form mt-2" method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control @error('nik') is-invalid @enderror" id="login-nik" name="nik"
                placeholder="320xxxxxxxxxx" aria-describedby="login-nik" tabindex="1" autofocus
                value="{{ old('nik') }}" />
              @error('nik')
            ...
            <button type="submit" class="btn btn-warning w-100" tabindex="4">Masuk</button>
          </form>
