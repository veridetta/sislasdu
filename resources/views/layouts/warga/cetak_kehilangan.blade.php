...
<body style="padding-top:0px !important;margin-top:0px !important">
  <table style="padding-top:0px !important">
    ...
    <table style="width:98%; margin-top:20px;">
        <tr>
          <td style="text-align: center;line-height:0 !important;"><h1><strong><u>SURAT KETERANGAN</u></strong></h1></td>
        </tr>
        <tr>
    ...
    <table>
      ...
      <tr>
        <td style="width: 40%;">Yang bertanda tangan dibawah ini </td>
        <td style="width: 5%;">:</td>
        <td></td>
      </tr>
    <tr>
    ...
    <table style="width:95% !important">
        ...
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Bahwa nama tersebut diatas adalah penduduk Desa Bakunglor Kecamatan Jamblang Kabupaten Cirebon dan menurut pengakuannya yang bersangkutan telah kehilangan sebuah Buku Nikah suami istri ( nama suami dan nama istri)</td></tr>
      <tr><td>Surat Keterangan ini digunakan untuk :</td></tr>
      <tr style="text-align: center;"><td><strong>&ldquo;PERSYARATAN SURAT KEHILANGAN&rdquo;</strong></td></tr>
