...
<section id="dashboard-analytics">
  @include('panels.flash')
      <div class="col-lg-12 col-sm-12 col-12">
        ...
        aria-controls="DataTables_Table_0" type="button" data-bs-toggle="modal" data-bs-target="#backdrop"><span>Buat Pengaduan</span></button>
        @endif
        <div class="card">
          <div class="card-header bg-light-primary flex-column align-items-start">
            <div class="row col-12">
                ...
                <div class="col-lg-11 col-10 my-auto">
                    <p class="h4 card-text">Riwayat Pengaduan</p>
                </div>
            </div>
          </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="myModalLabel4">Buat Pengaduan</h4>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <form class="add-new-user pt-0" enctype="multipart/form-data"  method="POST" action="{{route('pengaduan-add-warga')}}">
                @csrf
                <input type="hidden" name="id" value="" id="id_pengaduan"/>
                <div class="mb-1">
                  <label class="form-label" for="basic-icon-default-tanggal">Tanggal Pengaduan</label>
                  <input
                    type="date"
                ...
                <div class="mb-1">
                  <label class="form-label" for="basic-icon-default-nama">Nama Pengadu</label>
                  <input
                    type="text"
                ...
                <div class="mb-1">
                  <label class="form-label" for="basic-icon-default-judul">Judul Pengaduan</label>
                  <input
                    type="text"
