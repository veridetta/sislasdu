...
<body style="padding-top:0px !important;margin-top:0px !important">
  <table style="padding-top:0px !important">
    ...
    <table style="width:98%; margin-top:20px;">
        <tr>
          <td style="text-align: center;line-height:0 !important;"><h1><strong><u>SURAT KETERANGAN BELUM PERNAH MENIKAH</u></strong></h1></td>
        </tr>
        <tr>
    ...
    <table style="width:95% !important">
        ...
        <tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Benar nama tersebut diatas adalah penduduk Desa Bakunglor, Kecamatan Jamblang, Kabupaten Cirebon dan yang bersangkutang masih bersatus <strong>Belum Pernah Menikah</strong>.</td></tr>
      <tr><td>Surat Keterangan ini diberikan kepada yang bersangkutan untuk dipergunakan sebagai kelengkapan persyaratan :</td></tr>
      <tr style="text-align: center;"><td><strong>&ldquo;{{$surat->keperluan}}&rdquo;</strong></td></tr>
