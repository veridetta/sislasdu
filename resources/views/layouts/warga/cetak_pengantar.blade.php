...
<body style="padding-top:0px !important;margin-top:0px !important">
  <table style="padding-top:0px !important">
    ...
    <table style="width:98%; margin-top:20px;">
        <tr>
          <td style="text-align: center;line-height:0 !important;"><h1><strong><u>SURAT PENGANTAR RT</u></strong></h1></td>
        </tr>
        <tr>
    ...
    <table>
      <tr>
        <td style="width: 90%;">Yang bertanda tangan dibawah ini, atas nama Ketua RT {{$surat->rt}} Desa Bakunglor Kecamatan Jamblang Kabupaten Cirebon, menerangkan bahwa :</td>
      </tr>
    </table>
    <table>
    <tr>
    ...
    <tr>
      <td style="width: 20%;">Maksud & Keperluan</td>
      <td style="width: 5%;">:</td>
      <td style="width: 70%;">{{$surat->keperluan}}</td>
    </tr>
    ...
    <table>
      <tr style="text-align: right;">
        <td>Ketua RT {{$surat->rt}}</td>
        <td width="5"></td>
        <td>Ketua RW {{$surat->rw}}</td>
      </tr>
      <tr style="text-align: right;"">
        <td><img src="{{asset('images/logo/logo.png')}}" alt="" width="100" height="80" /></td>
        <td width="5"></td>
        <td><img src="{{asset('images/logo/logo.png')}}" alt="" width="100" height="80" /></td>
      </tr>
      <tr style="text-align: right;">
