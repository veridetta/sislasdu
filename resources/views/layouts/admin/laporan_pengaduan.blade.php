          ...
          <div class="card-header bg-warning flex-column align-items-start">
            <div class="row col-12">
                ...
                <div class="col-lg-11 col-10 my-auto">
                    <p class="h4 card-text text-white">Laporan Pengaduan</p>
                </div>
            </div>
          </div>
          <div class="card-body" >
...
$(function () {
  ...
  if (dt_adv_filter_table.length) {
    var dt_adv_filter = dt_adv_filter_table.DataTable({
      ajax: "{{route('pengaduan-data-admin')}}",//assetPath + 'data/table-datatable.json',
      columns: [
        { data: '' },
        { data: 'foto' },
        { data: 'nama' },
      ...
      columnDefs: [
        {
            ...
            render: function (data, type, full, meta) {
              var ff="'"+full.foto+"','"+full.judul+"'";
              var ret='<a class="d-flex flex-row p-1 align-items-center" onclick="viewImage('+ff+')"><img class="me-1" src="http://sislasdu.test/images/icons/jpg.png" alt="data.json" height="18"><span class="mb-0 h6 badge badge-light-primary badge-glow">buka lampiran</span></a>';
              return ret;
            }
          },
            {
