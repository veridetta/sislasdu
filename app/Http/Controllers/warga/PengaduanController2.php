...
class PengaduanController2 extends Controller
{
    public function index()
    {
        ...
        $data=Pengaduan::where('id_users','=',Auth::user()->id)->get();
        ...
        return view('layouts/warga/pengaduan', ['val'=>$val,'data'=>$data,'pageConfigs' => $pageConfigs, 'breadcrumbs' => $breadcrumbs,'status'=>$status]);
    }
    ...
    public function pengaduan_add(Request $request){
      ...
      return redirect()->route('pengaduan-warga');
    }
}
