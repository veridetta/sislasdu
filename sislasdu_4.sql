...
-- Dumping data for table sislasdu.informasis: ~0 rows (approximately)
...
-- Dumping data for table sislasdu.jenis_surats: ~7 rows (approximately)
INSERT INTO `jenis_surats` (`id`, `created_at`, `updated_at`, `kode`, `nama`, `keterangan`) VALUES
	...
	(8, '2023-04-05 08:39:34', '2023-04-05 08:39:34', 'SK-CK', 'Surat Ketetrangan Catatan Kelakuan', 'Surat Ketetrangan Catatan Kelakuan');
...
-- Dumping data for table sislasdu.migrations: ~20 rows (approximately)
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(36, '2023_04_05_132533_create_perangkats_table', 4),
	(37, '2023_03_21_163950_create_pengaduans_table', 5);
...
CREATE TABLE IF NOT EXISTS `pengaduans` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_users` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tanggal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `judul` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `foto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table sislasdu.pengaduans: ~0 rows (approximately)

-- Dumping structure for table sislasdu.perangkats
...
-- Dumping data for table sislasdu.perangkats: ~2 rows (approximately)
INSERT INTO `perangkats` (`id`, `nama`, `nik`, `jabatan`, `created_at`, `updated_at`) VALUES
	(1, 'Sohib 2', '233232321', 'Ka Koordinator', '2023-04-05 06:39:44', '2023-04-05 08:07:02'),
	(2, 'Bubi', '32119989898', 'Jabar', '2023-04-05 06:42:47', '2023-04-05 06:42:47');
...
-- Dumping data for table sislasdu.rtrws: ~3 rows (approximately)
INSERT INTO `rtrws` (`id`, `rt`, `rw`, `created_at`, `updated_at`) VALUES
	(1, '04', '01', '2023-03-21 23:18:29', '2023-03-21 23:19:28'),
	(3, '03', '01', '2023-03-25 19:26:11', '2023-03-25 19:26:11'),
	(4, '11', '10', '2023-03-25 19:26:23', '2023-03-25 19:26:23');
...
-- Dumping data for table sislasdu.rts: ~0 rows (approximately)
INSERT INTO `rts` (`id`, `id_users`, `rw`, `rt`, `name`, `created_at`, `updated_at`, `email`) VALUES
	(1, 6, '04/01', '04/01', 'Junaini 2', '2023-03-22 02:42:15', '2023-04-03 10:53:46', 'junainiw@gmail.com');
...
-- Dumping data for table sislasdu.rws: ~0 rows (approximately)
INSERT INTO `rws` (`id`, `id_users`, `rw`, `name`, `created_at`, `updated_at`, `email`) VALUES
	(1, 9, '01', 'Ziku 2', '2023-03-22 02:58:36', '2023-03-22 02:58:47', 'ziku@gmail.com');
...
-- Dumping data for table sislasdu.sessions: ~2 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('I9PFlBSjcA9oFZuSJK2srudnlliMX4Ii734vzc7c', 11, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', '', 1680818247),
	('kFE4KbtkW6lY7KuCWAlT8UdpApr4s2XDIOspar3K', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiSHpaU0M2M3pVZUk4Z0IyWUVMUlRjOTJJd2x1eGdzSUM5aVhjdHpJNCI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1680816393);

-- Dumping structure for table sislasdu.surats
CREATE TABLE IF NOT EXISTS `surats` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_users` int NOT NULL,
  `id_jenissurat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `kode` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nama` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nik` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `st_nikah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table sislasdu.surats: ~9 rows (approximately)
INSERT INTO `surats` (`id`, `id_users`, `id_jenissurat`, `kode`, `nama`, `nik`, `tempat_lahir`, `tanggal_lahir`, `jk`, `agama`, `pekerjaan`, `st_nikah`, `alamat`, `keperluan`, `status`, `created_at`, `updated_at`) VALUES
	...
	(3, 11, 'SK-HILANG', '001/03-Apr/SK-HILANG/2023', 'Warga Dolakpur', '32666777766', 'Cirebon', '22/02/2000', 'Laki-laki', 'Islam', 'Pegawai Negeri', 'Belum Menikah', 'RT/RW 04/01 Desa Bakunglor Kec. Jamblang Kab/Kota Cirebon Provinsi Jawa Barat', 'Tidak ada', '1', '2023-04-03 09:43:44', '2023-04-03 09:43:44'),
	(4, 11, 'SK-DOM', '002/03-Apr/SK-DOM/2023', 'Warga Dolakpur', '32666777766', 'Cirebon', '22/02/2000', 'Laki-laki', 'Islam', 'Pegawai Negeri', 'Belum Menikah', 'RT/RW 04/01 Desa Bakunglor Kec. Jamblang Kab/Kota Cirebon Provinsi Jawa Barat', 'bismillah', '1', '2023-04-03 10:29:14', '2023-04-03 10:29:14'),
	(5, 11, 'SK-HILANG', '003/03-Apr/SK-HILANG/2023', 'Warga Dolakpur', '32666777766', 'Cirebon', '22/02/2000', 'Laki-laki', 'Islam', 'Pegawai Negeri', 'Belum Menikah', 'RT/RW 04/01 Desa Bakunglor Kec. Jamblang Kab/Kota Cirebon Provinsi Jawa Barat', 'tes', '1', '2023-04-03 10:30:32', '2023-04-03 10:30:32'),
	(6, 11, 'SK-HILANG', '004/03-Apr/SK-HILANG/2023', 'Warga Dolakpur', '32666777766', 'Cirebon', '22/02/2000', 'Laki-laki', 'Islam', 'Pegawai Negeri', 'Belum Menikah', 'RT/RW 04/01 Desa Bakunglor Kec. Jamblang Kab/Kota Cirebon Provinsi Jawa Barat', 'wa', '1', '2023-04-03 10:32:27', '2023-04-03 10:32:27'),
	(7, 11, 'SK-HILANG', '005/03-Apr/SK-HILANG/2023', 'Warga Dolakpur', '32666777766', 'Cirebon', '22/02/2000', 'Laki-laki', 'Islam', 'Pegawai Negeri', 'Belum Menikah', 'RT/RW 04/01 Desa Bakunglor Kec. Jamblang Kab/Kota Cirebon Provinsi Jawa Barat', 'zzzzzz', '1', '2023-04-03 10:49:51', '2023-04-03 10:49:51'),
	(8, 11, 'SK-CK', '006/05-Apr/SK-CK/2023', 'Warga Dolakpur', '32666777766', 'Cirebon', '22/02/2000', 'Laki-laki', 'Islam', 'Pegawai Negeri', 'Belum Menikah', 'RT/RW 04/01 Desa Bakunglor Kec. Jamblang Kab/Kota Cirebon Provinsi Jawa Barat', 'Daftar SEkolah', '2', '2023-04-05 08:49:49', '2023-04-05 08:56:38'),
	(9, 11, 'SK-CK', '007/05-Apr/SK-CK/2023', 'Warga Dolakpur', '32666777766', 'Cirebon', '22/02/2000', 'Laki-laki', 'Islam', 'Pegawai Negeri', 'Belum Menikah', 'RT/RW 04/01 Desa Bakunglor Kec. Jamblang Kab/Kota Cirebon Provinsi Jawa Barat', 'Daftar SEkolah', '1', '2023-04-05 08:50:37', '2023-04-05 08:50:37');
...
INSERT INTO `users` (`id`, `name`, `email`, `nik`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `two_factor_confirmed_at`, `jabatan`, `role`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(6, 'Junaini 2', '', '32129800000', '$2y$10$931maO5L/OwDjRpmsj5skezsiN1pWkjMzxxwFC4ZZ0SI.mv4.WpQO', NULL, NULL, NULL, 'rt', 'rt', 'xyboQtxMmsk4m3ttLf4I78qPRdmGm1ipggtBP4Fb9SaOE1lNMcUNKTmzFUdi', '2023-03-22 02:42:15', '2023-04-03 10:53:46'),
	...
	(11, 'Warga Dolakpur 2', 'veridetta@gmail.com', '32666777766', '$2y$10$Sg8yjM1hQ9na7PQGTYf1t.9Q3LLpbnVlex2mENfrhPGOMj0SiwV7y', NULL, NULL, NULL, 'warga', 'warga', 'P2NU9PmqCaisTS8F228ccWhC0PG8PLFmDo0ItB4kbT1dxvO0RVZOefBCSFCs', '2023-03-22 13:27:31', '2023-04-06 14:57:02');
...
CREATE TABLE IF NOT EXISTS `wargas` (
  ...
  `st_nikah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `st_tinggal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `st_warga` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rt` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rw` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table sislasdu.wargas: ~4 rows (approximately)
INSERT INTO `wargas` (`id`, `id_users`, `nik`, `nama`, `tempat_lahir`, `tanggal_lahir`, `jk`, `goldar`, `agama`, `pekerjaan`, `pendidikan`, `st_nikah`, `st_tinggal`, `st_warga`, `rt`, `rw`, `desa`, `kecamatan`, `kota`, `provinsi`, `created_at`, `updated_at`) VALUES
	...
	(4, 11, '32666777766', 'Warga Dolakpur 2', 'Cirebon', '22/02/2000', 'Laki-laki', 'Kosong', 'Islam', 'Pegawai Negeri', 'Tidak Sekolah', 'Belum Menikah', 'Rumah Sendiri', 'Penduduk', '04/01', '04/01', 'Bakunglor', 'Jamblang', 'Cirebon', 'Jawa Barat', '2023-03-22 14:28:17', '2023-04-05 11:43:10');
